...
const supabase = createClient(
  ...
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBmb3Z6bHFudnZhZmllc3dnZWRuIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxNjk3MTU3MiwiZXhwIjoyMDMyNTQ3NTcyfQ.0mNEZB0RtYzU6ao--_naEHVLzvyCW60LCHqglbRXl7g",
  {
  ...
  for (const user of userIds) {
    for (
      ...
      for (let i = 0; i < 10; i++) {
        ...
        switch (type) {
          case "Income":
            amount = faker.number.int({ min: 3000000, max: 6000000 });
            break;
          case "Expense":
